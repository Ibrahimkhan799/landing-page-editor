  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Field label="W">
          <Input value={current.width ?? ""} placeholder={live.width} onChange={(event) => patch({ width: event.target.value })} />
        </Field>
        <Field label="H">
          <Input value={current.height ?? ""} placeholder={live.height} onChange={(event) => patch({ height: event.target.value })} />
        </Field>
        <Field label="Min W">
          <Input value={current.minWidth ?? ""} placeholder={live.minWidth} onChange={(event) => patch({ minWidth: event.target.value })} />
        </Field>
        <Field label="Min H">
          <Input value={current.minHeight ?? ""} placeholder={live.minHeight} onChange={(event) => patch({ minHeight: event.target.value })} />
        </Field>
        <Field label="Max W">
          <Input value={current.maxWidth ?? ""} placeholder={live.maxWidth} onChange={(event) => patch({ maxWidth: event.target.value })} />
        </Field>
        <Field label="Max H">
          <Input value={current.maxHeight ?? ""} placeholder={live.maxHeight} onChange={(event) => patch({ maxHeight: event.target.value })} />
        </Field>
      </div>
      <div className="grid grid-cols-2 gap-2">
        <SelectField
        ...
        />
        <Field label="Z">
          <Input value={current.zIndex ?? ""} placeholder={live.zIndex || "auto"} onChange={(event) => patch({ zIndex: event.target.value })} />
        </Field>
      </div>
      <div className="grid grid-cols-2 gap-2">
        <Field label="Rotate">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Field label="Gap">
          <Input value={current.gap ?? ""} placeholder={live.gap || "0px"} onChange={(event) => patch({ gap: event.target.value })} />
        </Field>
        <SelectField
          label="Overflow"
      ...
      <div className="grid grid-cols-2 gap-2">
        <Field label="Size">
          <Input value={current.fontSize ?? ""} placeholder={live.fontSize} onChange={(event) => patch({ fontSize: event.target.value })} />
        </Field>
        <SelectField
          label="Weight"
        ...
        />
        <Field label="Line">
          <Input value={current.lineHeight ?? ""} placeholder={live.lineHeight} onChange={(event) => patch({ lineHeight: event.target.value })} />
        </Field>
        <Field label="Letter">
          <Input value={current.letterSpacing ?? ""} placeholder={live.letterSpacing || "0"} onChange={(event) => patch({ letterSpacing: event.target.value })} />
        </Field>
        <SelectField
          label="Align"
      ...
      <div className="grid grid-cols-2 gap-2">
        <Field label="Stroke">
          <Input value={current.borderWidth ?? ""} placeholder={live.borderWidth || "0px"} onChange={(event) => patch({ borderWidth: event.target.value })} />
        </Field>
        <SelectField
          label="Style"
      ...
      />
      <Field label="Radius">
        <Input value={current.borderRadius ?? ""} placeholder={live.borderRadius} onChange={(event) => patch({ borderRadius: event.target.value })} />
      </Field>
      <Separator />
